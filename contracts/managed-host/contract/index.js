...
class _CommitteeSlot_0 {
  ...
  fromValue(value_0) {
    return {
      pkX: _descriptor_3.fromValue(value_0),
      pkY: _descriptor_3.fromValue(value_0),
      addedAtGen: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_3.toValue(value_0.pkX).concat(_descriptor_3.toValue(value_0.pkY).concat(_descriptor_1.toValue(value_0.addedAtGen)));
  }
}

const _descriptor_7 = new _CommitteeSlot_0();
...
class _SchnorrSignature_0 {
  ...
  toValue(value_0) {
    return _descriptor_8.toValue(value_0.announcement).concat(_descriptor_3.toValue(value_0.response));
  }
}
...
class _SchnorrHashInput_0 {
  alignment() {
    return _descriptor_3.alignment().concat(_descriptor_3.alignment().concat(_descriptor_3.alignment().concat(_descriptor_3.alignment().concat(_descriptor_10.alignment()))));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_3.toValue(value_0.ann_x).concat(_descriptor_3.toValue(value_0.ann_y).concat(_descriptor_3.toValue(value_0.pk_x).concat(_descriptor_3.toValue(value_0.pk_y).concat(_descriptor_10.toValue(value_0.msg)))));
  }
}

const _descriptor_20 = new _SchnorrHashInput_0();

const _descriptor_21 = new __compactRuntime.CompactTypeVector(2, _descriptor_3);
...
const _descriptor_24 = new __compactRuntime.CompactTypeVector(3, _descriptor_3);
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      attestNulOf(context, ...args_1) {
        return { result: pureCircuits.attestNulOf(...args_1), context };
      },
      ...
      addCommitteeSlot: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`addCommitteeSlot: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const slot_0 = args_1[1];
        const pkX_0 = args_1[2];
        const pkY_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('addCommitteeSlot',
                                     'argument 1 (as invoked from Typescript)',
                                     'host.compact line 106 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        if (!(typeof(pkX_0) === 'bigint' && pkX_0 >= 0 && pkX_0 <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('addCommitteeSlot',
                                     'argument 2 (argument 3 as invoked from Typescript)',
                                     'host.compact line 106 char 1',
                                     'Field',
        ...
        if (!(typeof(pkY_0) === 'bigint' && pkY_0 >= 0 && pkY_0 <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('addCommitteeSlot',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_6.toValue(slot_0).concat(_descriptor_3.toValue(pkX_0).concat(_descriptor_3.toValue(pkY_0))),
            alignment: _descriptor_6.alignment().concat(_descriptor_3.alignment().concat(_descriptor_3.alignment()))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
        };
        const result_0 = this._addCommitteeSlot_0(context,
                                                  partialProofData,
                                                  slot_0,
                                                  pkX_0,
                                                  pkY_0);
      ...
      openEpoch: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(epoch_0).concat(_descriptor_3.toValue(snapshotRoot_0)),
      ...
      attestVote: (...args_1) => {
        if (args_1.length !== 5) {
          throw new __compactRuntime.CompactError(`attestVote: expected 5 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const epoch_0 = args_1[1];
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(epoch_0).concat(_descriptor_6.toValue(slot_0).concat(_descriptor_8.toValue(pk_0).concat(_descriptor_9.toValue(sig_0)))),
            alignment: _descriptor_1.alignment().concat(_descriptor_6.alignment().concat(_descriptor_8.alignment().concat(_descriptor_9.alignment())))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      sealEpoch: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`sealEpoch: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const epoch_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(epoch_0),
        ...
        const result_0 = this._sealEpoch_0(context, partialProofData, epoch_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      rotateCommittee: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`rotateCommittee: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('rotateCommittee',
                                     'argument 1 (as invoked from Typescript)',
                                     'host.compact line 172 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._rotateCommittee_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      requireCurrentOwnerAttested: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(epoch_0).concat(_descriptor_5.toValue(rootIdCommit_0).concat(_descriptor_5.toValue(currentIdCommit_0))),
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(slots_0) === 'bigint' && slots_0 >= 0n && slots_0 <= 255n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 2 (argument 3 as invoked from Typescript)',
                                 'host.compact line 58 char 1',
                                 'Uint<0..256>',
    ...
    state_0.setOperation('addCommitteeSlot', new __compactRuntime.ContractOperation());
    ...
    state_0.setOperation('rotateCommittee', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(2n),
                                                                                              alignment: _descriptor_6.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(slots_0),
                                                                                              alignment: _descriptor_6.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _attestDigest_0(tag_0, gen_0, epoch_0, snapshotRoot_0) {
    const packed_0 = __compactRuntime.addField(__compactRuntime.mulField(gen_0,
                                                                         4294967296n),
                                               epoch_0);
    return [this._attestDomain_0(), tag_0, packed_0, snapshotRoot_0];
  }
  _attestNulOf_0(gen_0, epoch_0, slot_0) {
    return this._upgradeFromTransient_0(this._transientHash_1([gen_0,
                                                               epoch_0,
                                                               slot_0]));
  }
  ...
  _addCommitteeSlot_0(context, partialProofData, slot_0, pkX_0, pkY_0) {
    let t_0;
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_6.toValue(0n),
                                                                                                                   alignment: _descriptor_6.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(slot_0),
                                                                                                                                               alignment: _descriptor_6.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'slot already filled');
    const tmp_0 = { pkX: pkX_0,
                    pkY: pkY_0,
                    addedAtGen:
                      ((t1) => {
                        if (t1 > 4294967295n) {
                          throw new __compactRuntime.CompactError('host.compact line 111 char 17: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                        }
                        return t1;
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_6.toValue(8n),
                                                                                                                   alignment: _descriptor_6.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(epoch_0),
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(epoch_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(snapshotRoot_0),
                                                                                              alignment: _descriptor_3.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
  ...
  _attestVote_0(context, partialProofData, epoch_0, slot_0, pk_0, sig_0) {
    __compactRuntime.assert(!_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
    ...
    __compactRuntime.assert(_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
                            'epoch not open');
    const root_0 = _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                             partialProofData,
                                                                             [
                                                                              { dup: { n: 0 } },
                                                                              { idx: { cached: false,
                                                                              ...
                                                                              { idx: { cached: false,
                                                                                       ...
                                                                                       path: [
                                                                                              { tag: 'value',
                                                                                                value: { value: _descriptor_1.toValue(epoch_0),
                                                                                                         alignment: _descriptor_1.alignment() } }] } },
                                                                              { popeq: { cached: false,
                                                                                         result: undefined } }]).value);
    const gen_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('host.compact line 134 char 15: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
                  })(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
                             ...
                             _descriptor_6.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: false,
                                                                                                   result: undefined } }]).value)),
                            'slot out of range');
    const c_0 = _descriptor_7.fromValue(__compactRuntime.queryLedgerState(context,
                                                                          partialProofData,
                                                                          [
                                                                           { dup: { n: 0 } },
                                                                           { idx: { cached: false,
    ...
    this._schnorrVerifyDigest_0(context,
                                partialProofData,
                                this._attestDigest_0(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                               partialProofData,
                                                                                                               [
                                                                                                                { dup: { n: 0 } },
                                                                                                                { idx: { cached: false,
                                ...
                                sig_0,
                                pk_0);
    const nul_0 = this._attestNulOf_0(gen_0, epoch_0, slot_0);
    __compactRuntime.assert(!_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
  ...
  _sealEpoch_0(context, partialProofData, epoch_0) {
    __compactRuntime.assert(!_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
    ...
    const hi_0 = ((t1) => {
                   if (t1 > 18446744073709551615n) {
                     throw new __compactRuntime.CompactError('host.compact line 161 char 14: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                   }
                   return t1;
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(epoch_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(hi_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_2 = 1n;
  ...
  _rotateCommittee_0(context, partialProofData) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                 ...
                                 currentIdCommit_0)
  {
    ...
    __compactRuntime.assert(this._blockTimeLt_0(context,
                                                ...
                                                ((t1) => {
                                                  if (t1 > 18446744073709551615n) {
                                                    throw new __compactRuntime.CompactError('host.compact line 189 char 22: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                                                  }
                                                  return t1;
                                                })(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                             partialProofData,
                                                                                   ...
                                                                                   path: [
                                                                                          { tag: 'value',
                                                                                            value: { value: _descriptor_6.toValue(1n),
                                                                                                     alignment: _descriptor_6.alignment() } }] } },
                                                                          { push: { storage: false,
                                                                                    value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(1048576n),
                                                                                                                                 alignment: _descriptor_2.alignment() }).encode() } },
                                                                          'lt',
                                                                          'neg',
                                                                          { popeq: { cached: true,
...
export const pureCircuits = {
  ...
  attestNulOf: (...args_0) => {
    if (args_0.length !== 3) {
      throw new __compactRuntime.CompactError(`attestNulOf: expected 3 arguments (as invoked from Typescript), received ${args_0.length}`);
    }
    const gen_0 = args_0[0];
    const epoch_0 = args_0[1];
    const slot_0 = args_0[2];
    if (!(typeof(gen_0) === 'bigint' && gen_0 >= 0n && gen_0 <= 4294967295n)) {
      __compactRuntime.typeError('attestNulOf',
                                 'argument 1',
    ...
    return _dummyContract._attestNulOf_0(gen_0, epoch_0, slot_0);
  }
};
