...
export class Contract {
  ...
  _openEpoch_0(context, partialProofData, epoch_0, snapshotRoot_0) {
    ...
    const prop_0 = this._epochProposalOf_0(((t1) => {
                                             if (t1 > 4294967295n) {
                                               throw new __compactRuntime.CompactError('host.compact line 173 char 32: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                                             }
                                             return t1;
                ...
                sig_0)
  {
    ...
    const gen_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('host.compact line 187 char 15: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
                  })(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
  ...
  _sealEpoch_0(context, partialProofData, epoch_0, snapshotRoot_0) {
    ...
    __compactRuntime.assert(this._equal_0(epoch_0,
                                          ((t1) => {
                                            if (t1 > 4294967295n) {
                                              throw new __compactRuntime.CompactError('host.compact line 205 char 29: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                                            }
                                            return t1;
                                          })(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                       partialProofData,
    ...
    const prop_0 = this._epochProposalOf_0(((t1) => {
                                             if (t1 > 4294967295n) {
                                               throw new __compactRuntime.CompactError('host.compact line 207 char 32: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                                             }
                                             return t1;
                                           })(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                        partialProofData,
    ...
    const hi_0 = ((t1) => {
                   if (t1 > 18446744073709551615n) {
                     throw new __compactRuntime.CompactError('host.compact line 214 char 14: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                   }
                   return t1;
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(epoch_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(hi_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_1 = 1n;
  ...
  _openRotation_0(context, partialProofData, targetSlot_0, newPkX_0, newPkY_0) {
    ...
    const prop_0 = this._rotationProposalOf_0(((t1) => {
                                                if (t1 > 4294967295n) {
                                                  throw new __compactRuntime.CompactError('host.compact line 233 char 35: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                                                }
                                                return t1;
                                              })(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                           partialProofData,
                ...
                sig_0)
  {
    const gen_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('host.compact line 246 char 15: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
                  })(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
  ...
  _sealRotation_0(context, partialProofData, targetSlot_0, newPkX_0, newPkY_0) {
    ...
    const tmp_1 = { pkX: newPkX_0,
                    ...
                    addedAtGen:
                      ((t1) => {
                        if (t1 > 4294967295n) {
                          throw new __compactRuntime.CompactError('host.compact line 266 char 63: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                        }
                        return t1;
                      })(gen_0 + 1n) };
    __compactRuntime.queryLedgerState(context,
                                 ...
                                 currentIdCommit_0)
  {
    ...
    __compactRuntime.assert(!(tmp_0 = ((t1) => {
                                        if (t1 > 4294967295n) {
                                          throw new __compactRuntime.CompactError('host.compact line 284 char 32: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                                        }
                                        return t1;
                                      })(epoch_0 + 1n),
                              _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    __compactRuntime.assert(this._blockTimeLt_0(context,
                                                ...
                                                ((t1) => {
                                                  if (t1 > 18446744073709551615n) {
                                                    throw new __compactRuntime.CompactError('host.compact line 285 char 22: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                                                  }
                                                  return t1;
                                                })(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                             partialProofData,
